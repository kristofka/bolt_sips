defmodule Bolt.Sips.Internals.PackStream.Decoder do
  ...
  def decode(<<@null_marker, rest::binary>>, bolt_version) when bolt_version <= 3 do
    [nil | decode(rest, bolt_version)]
  end

  # Boolean
  def decode(<<@true_marker, rest::binary>>, bolt_version) when bolt_version <= 3 do
    [true | decode(rest, bolt_version)]
  end

  def decode(<<@false_marker, rest::binary>>, bolt_version) when bolt_version <= 3 do
  ...
  def decode("", bolt_version) when bolt_version <= 3 do
    []
  end
